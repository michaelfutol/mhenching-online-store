...
-- Public schemas can be exposed through Supabase Data API depending on project
-- settings. Explicit RLS and read-only grants are therefore intentional.
...
-- No anonymous/browser write grants are intentionally defined.

-- -----------------------------------------------------------------------------
-- PRIVATE COMMERCE DATA
-- Keep this schema out of exposed Data API schemas.
-- -----------------------------------------------------------------------------
...
-- Defense in depth. The private schema should also remain unexposed and have no
